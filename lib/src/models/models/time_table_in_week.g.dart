...
part of 'time_table_in_week.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TimeTableInWeek _$TimeTableInWeekFromJson(Map<String, dynamic> json) =>
    TimeTableInWeek(
...
Map<String, dynamic> _$TimeTableInWeekToJson(TimeTableInWeek instance) =>
    <String, dynamic>{
