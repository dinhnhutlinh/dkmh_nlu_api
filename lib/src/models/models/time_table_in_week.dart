...
part 'time_table_in_week.g.dart';
...
class TimeTableInWeek extends Equatable {
  ...
  factory TimeTableInWeek.fromJson(Map<String, dynamic> json) {
    return _$TimeTableInWeekFromJson(json);
  }

  Map<String, dynamic> toJson() => _$TimeTableInWeekToJson(this);
